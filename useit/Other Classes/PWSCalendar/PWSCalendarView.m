...
- (void) SetDataHeadView
{
    ...
    // segment
    NSArray* items = [NSArray arrayWithObjects:[self GetSegmentItemWithTitle:@"giornaliero"], [self GetSegmentItemWithTitle:@"settimanale"], [self GetSegmentItemWithTitle:@"mensile"], nil];
